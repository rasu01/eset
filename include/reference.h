...
namespace eset {
    ...
    struct ReferenceData {
        ...
        //since the underlying vector that stores the components can reallocate after it's capacity is too low, we cannot just save the raw pointer here
        ...
        public:
            ...
            */
            ...
            /*
                ...
                or the storage pointer is null.
            */
            ComponentType* operator->() const {
                return (ComponentType*)m_reference_data->m_storage->get_component_pointer(m_reference_data->m_offset);
            }
